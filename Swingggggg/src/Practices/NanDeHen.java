...
public class NanDeHen extends JFrame{
	...
	public NanDeHen() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Field[] fields = NanDeHen.class.getDeclaredFields(); // 通过Java反射机制获得类中的所有属性
